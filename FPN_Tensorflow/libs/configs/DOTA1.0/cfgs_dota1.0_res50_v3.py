...
This is your evaluation result for task 2:
    ...
    mAP: 0.7589413254652073
    ap of each class:
    plane:0.9010466470049403,
    baseball-diamond:0.8313518348956522,
    bridge:0.5722016349881877,
    ground-track-field:0.6856347288593221,
    small-vehicle:0.7866249076786525,
    large-vehicle:0.7561947480696583,
    ship:0.8714911374767136,
    tennis-court:0.9083982005927707,
    basketball-court:0.8630819071359233,
    storage-tank:0.8575243100178387,
    soccer-ball-field:0.5807845702796978,
    roundabout:0.6890035704223404,
    harbor:0.7519652540705581,
    swimming-pool:0.7818801986611843,
    helicopter:0.5469362318246699

The submitted information is :

Description: FPN_Res50D_DOTA1.0_20191218_v3_30w
Username: yangxue
...
# ------------------------------------------------
VERSION = 'FPN_Res50D_DOTA1.0_20191218_v3'
