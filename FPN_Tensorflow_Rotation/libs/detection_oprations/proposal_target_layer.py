...
def proposal_target_layer(rpn_rois, gt_boxes_h, gt_boxes_r):
    ...
    labels, rois, bbox_targets_r = _sample_rois(all_rois, gt_boxes_h, gt_boxes_r,
...
def _compute_targets_h(ex_rois, gt_rois, labels):
...
def _sample_rois(all_rois, gt_boxes_h, gt_boxes_r, fg_rois_per_image,
    ...
    bbox_target_data_r = _compute_targets_r(
