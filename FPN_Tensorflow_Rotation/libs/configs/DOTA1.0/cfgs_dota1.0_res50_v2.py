...
This is your result for task 1:
    ...
    mAP: 0.6935231503349691
    ap of each class:
    plane:0.8990453919560449,
    baseball-diamond:0.7889413869332684,
    bridge:0.4588887954644771,
    ground-track-field:0.6236573569354328,
    small-vehicle:0.656792259882293,
    large-vehicle:0.7167238837809833,
    ship:0.7637363123226241,
    tennis-court:0.9070357905014953,
    basketball-court:0.8520914940681232,
    storage-tank:0.7774576420365371,
    soccer-ball-field:0.5509927378892633,
    roundabout:0.6077311598748057,
    harbor:0.5743219631975117,
    swimming-pool:0.688491596789867,
    helicopter:0.536939483391812

The submitted information is :

Description: FPN_Res50D_DOTA1.0_20191108_v2
Username: SJTU-Det
Institute: SJTU
...
# ------------------------------------------------
VERSION = 'FPN_Res50D_DOTA1.0_20191108_v2'
